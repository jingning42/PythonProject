...
def draw(canvas):
    global time, started, lives, score, rock_group, missile_group, timer, soundtrack
...
def group_group_collide(group1, group2):
    global score
    for each_item in set(group1):
        if group_collide(group2, each_item):
            score += 1
        group_collide(group2, each_item)
